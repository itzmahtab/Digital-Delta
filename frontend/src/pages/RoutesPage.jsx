                  ...
                  {vehicleTypes.map(vt => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex-1 flex flex-col items-center justify-center gap-1.5 py-3 rounded-2xl border-2 transition-all ${getVehicleColor(vt.color, isActive)}`}
                      >
            ...
            <div className="bg-slate-900 rounded-[32px] p-6 shadow-2xl shrink-0 text-white relative overflow-hidden">
              ...
              <div className="space-y-4 relative z-10">
                {activeRoutes.map((route, index) => (
                  <div key={route.id || index} className="p-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-3 pt-3 border-t border-white/10">
                      {route.edges?.map(edge => (
                        <span key={edge.id} className="px-2 py-1 bg-black/20 rounded-md text-[10px] font-mono font-bold text-slate-400 opacity-80">
